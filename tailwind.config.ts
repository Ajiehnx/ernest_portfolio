  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "title-lg": ["2.5rem", { lineHeight: "1.15", letterSpacing: "-0.02em" }],
      ...
      keyframes: {
        ...
        "cursor-ripple": {
          "0%": { width: "0px", height: "0px", opacity: "0.5", marginLeft: "0px", marginTop: "0px" },
          "100%": { width: "80px", height: "80px", opacity: "0", marginLeft: "-40px", marginTop: "-40px" },
        },
      },
      animation: {
