...
export const projects: Project[] = [
  {
    ...
    summary: "End-to-end transformation of a commercial bank's customer onboarding journey, addressing ID&V pain points, exception handling, and stage messaging to reduce rework and improve customer experience.",
    domain: "Banking",
    ...
    discovery: {
      ...
      workshops: "Facilitated workshops across operational and technology teams to map current state and identify improvement opportunities",
      painPoints: [
    ...
    approach: {
      asIs: "Documented the complete As-Is journey covering six swim lanes: Customer, Digital Platform, Automated Checks/Rules Engine, Onboarding Ops/KYC, Compliance/Fraud, and Customer Support. Identified handoff points, decision gates, and failure scenarios at each stage.",
      toBe: "Designed To-Be process incorporating clearer stage messaging for customers, structured exception handling pathways, improved handoffs between automated and manual processes, and GDPR-compliant data handling. Defined clear escalation routes and SLA expectations.",
      prioritisation: "MoSCoW prioritisation applied to requirements, with critical path items (ID&V improvements, stage messaging) marked as Must-Have for initial release",
      governance: "Delivery tracked through Azure DevOps with regular stakeholder reviews, RAID log maintenance, and sprint ceremonies"
    },
    deliverables: [
    ...
    outcomes: [
      {
        ...
        value: "[Add metric]",
        context: "Improvement expected through clearer stage messaging and reduced failures"
      },
      {
        metric: "ID&V first-time success rate",
        value: "[Add metric]",
        context: "Improvement through better upload guidance and error handling"
      },
      {
        metric: "Manual review rework reduction",
        value: "[Add metric]",
        context: "Achieved through structured handoffs and clear exception pathways"
      }
    ],
    artefacts: [
      {
  ...
  },
  {
    ...
    summary: "Designed a menu-led customer support chatbot to guide users through common onboarding queries, with structured knowledge base, escalation rules, and compliance guardrails.",
    domain: "Banking",
    role: "AI Business Analyst",
    dates: "Sep 2024 – Present",
    duration: "Ongoing",
    ...
    approach: {
      asIs: "Reviewed existing support channels and identified most common query types: upload help, ID&V troubleshooting, progress-stage guidance, and contact options. Mapped current escalation paths and identified gaps.",
      toBe: "Designed menu-led chatbot experience with structured response patterns, compliance guardrails, and clear escalation pathways for complex or sensitive queries. Incorporated safe handover to human agents for risk flags or repeated failures.",
      prioritisation: "Prioritised high-volume, low-complexity queries for automation, with clear escalation for anything requiring human judgement",
      governance: "Compliance review of all responses; regular review cycles for knowledge base accuracy"
    },
    deliverables: [
    ...
    outcomes: [
      {
        ...
        value: "[Add metric]",
        context: "Percentage of queries resolved without human agent involvement"
      },
      {
        metric: "Customer satisfaction score",
        value: "[Add metric]",
        context: "Post-interaction feedback on chatbot helpfulness"
      },
      {
        metric: "Escalation handling time",
        value: "[Add metric]",
        context: "Time from escalation trigger to human agent connection"
      }
    ],
    artefacts: [
      {
  ...
  },
  {
    ...
    summary: "Comprehensive requirements elicitation and discovery for a training delivery platform, covering learner journeys, course taxonomy, assessments, and admin workflows.",
    domain: "LMS",
    role: "AI Business Analyst",
    dates: "Sep 2024 – Present",
    duration: "Ongoing",
    ...
    problem: "The organisation required a structured approach to training delivery but lacked a cohesive system for managing learner journeys, course content, assessments, and completion tracking. Existing processes were fragmented and difficult to audit.",
    objectives: [
      {
        objective: "Establish clear learner journey framework",
        measure: "[Add metric – e.g., completion rate improvement]"
      },
      {
        objective: "Enable consistent course delivery and tracking",
        measure: "[Add metric – e.g., audit compliance rate]"
      },
      {
        objective: "Support phased delivery and vendor evaluation",
        measure: "[Add metric – e.g., requirements coverage in vendor selection]"
      }
    ],
    responsibilities: [
    ...
    discovery: {
      ...
      workshops: "Facilitated requirements workshops to understand learner needs, admin workflows, and compliance requirements",
      painPoints: [
    ...
    approach: {
      asIs: "Documented current state of training delivery including manual processes, system gaps, and pain points across learner, facilitator, and admin perspectives.",
      toBe: "Defined comprehensive LMS requirements including course catalogue taxonomy, enrolment automation, assessment frameworks, completion tracking, and reporting dashboards.",
      prioritisation: "User stories prioritised to support phased delivery, with core learner journeys and compliance tracking as Phase 1 priorities",
      governance: "Requirements managed through Azure DevOps with regular stakeholder reviews and traceability maintained"
    },
    deliverables: [
    ...
    outcomes: [
      {
        ...
        value: "[Add metric]",
        context: "Percentage of stakeholder needs captured and documented"
      },
      {
        metric: "Backlog readiness",
        value: "[Add metric]",
        context: "User stories refined and ready for development"
      }
    ],
    artefacts: [
      {
  ...
  },
  {
    ...
    summary: "Led analysis and delivery of multiple AI automation projects, from use case identification through to UAT and deployment, with strong requirements traceability and stakeholder engagement.",
    domain: "Automation",
    role: "AI Business Analyst",
    dates: "Sep 2024 – Present",
    duration: "Ongoing",
    ...
    problem: "The organisation needed to identify and deliver AI-powered automation opportunities that aligned with business priorities while ensuring responsible AI practices and strong delivery governance.",
    objectives: [
      {
    ...
    approach: {
      asIs: "Documented current manual processes and identified automation opportunities through structured feasibility analysis",
      toBe: "Designed AI-powered solutions with clear requirements, responsible AI guardrails, and measurable success criteria",
      prioritisation: "Use cases prioritised based on business value, feasibility, and data readiness",
      governance: "Delivery managed through Azure DevOps with sprint planning, backlog management, and regular stakeholder reviews"
    },
    deliverables: [
  ...
  },
  {
    ...
    summary: "Designed and deployed real-time dashboards for HR, Finance, and Operations, improving visibility of KPIs and enabling data-driven decisions.",
    domain: "Data/BI",
    ...
    problem: "Business leaders lacked timely visibility into key performance indicators across HR, Finance, and Operations. Reporting was manual, inconsistent, and often delayed, making it difficult to identify issues early or respond to changing priorities.",
    objectives: [
      {
        objective: "Improve KPI visibility across functions",
        measure: "[Add metric – e.g., dashboard adoption rate]"
      },
      {
        objective: "Reduce reporting lag",
        measure: "[Add metric – e.g., from weekly to real-time]"
      },
      {
        objective: "Improve data quality",
        measure: "[Add metric – e.g., reduction in reporting errors]"
      }
    ],
    responsibilities: [
    ...
    approach: {
      asIs: "Assessed current reporting processes and data sources across HR, Finance, and Operations. Identified gaps in data quality, consistency, and timeliness.",
      toBe: "Designed integrated Power BI dashboards with standardised KPI definitions, automated data refresh, and drill-down capabilities for each function.",
      prioritisation: "Prioritised high-impact KPIs with available data sources for initial release",
      governance: "Established reporting standards and data validation processes to maintain quality"
    },
    deliverables: [
    ...
    outcomes: [
      ...
      },
      {
        ...
        value: "[Add metric]",
        context: "From manual weekly reports to real-time visibility"
      },
      {
        metric: "Data quality improvement",
        value: "[Add metric]",
        context: "Reduction in reporting errors through validation checks"
      }
    ],
    artefacts: [
      {
  ...
  },
  {
    ...
    summary: "Delivered consulting projects focused on organisational change, process improvement, and performance management across public and private sector clients.",
    domain: "Consulting",
    ...
    problem: "Clients across healthcare, education, and housing sectors faced challenges with organisational efficiency, service delivery, and performance visibility. Many lacked structured approaches to change management and continuous improvement.",
    objectives: [
      {
        objective: "Improve organisational efficiency",
        measure: "[Add metric – e.g., cost savings achieved]"
      },
      {
        objective: "Enhance service delivery outcomes",
        measure: "[Add metric – e.g., user satisfaction improvement]"
      },
      {
        objective: "Establish performance management frameworks",
        measure: "[Add metric – e.g., adoption of scorecards]"
      }
    ],
    responsibilities: [
    ...
    discovery: {
      ...
      workshops: "Facilitated workshops and interviews to understand organisational challenges and improvement opportunities",
      painPoints: [
    ...
    approach: {
      asIs: "Assessed current organisational structures, processes, and performance frameworks to identify improvement opportunities",
      toBe: "Designed improved processes, organisational structures, and performance management frameworks tailored to client needs",
      prioritisation: "Recommendations prioritised based on impact, feasibility, and stakeholder readiness",
      governance: "Structured project governance with regular steering committees and progress reporting"
    },
    deliverables: [
    ...
    outcomes: [
      {
        ...
        value: "[Add metric]",
        context: "Cost-benefit analysis demonstrated improved efficiency"
      },
      {
        metric: "Scorecard adoption",
        value: "[Add metric]",
        context: "Templates and dashboards adopted across organisation"
      },
      {
        metric: "Client satisfaction",
        value: "[Add metric]",
        context: "Positive feedback from leadership teams"
      }
    ],
    artefacts: [
      {
